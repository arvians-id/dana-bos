		...
		<div class="header-body">
			<div class="row align-items-center py-4">
				<div class="col-lg-6 col-7">
					<h6 class="h2 text-white d-inline-block mb-0">Detail Kas Umum</h6>
					<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
						<ol class="breadcrumb breadcrumb-links breadcrumb-dark">
							<li class="breadcrumb-item"><a href="<?= base_url('admin') ?>">Admin</a></li>
							<li class="breadcrumb-item active" aria-current="page">Detail Kas Umum</li>
						</ol>
					</nav>
				</div>
			</div>
...
<div class="container-fluid mt--6">
	<div class="card mb-4">
		...
		<div class="card-body">
			...
			<a href="<?= base_url('admin/cetak_umum/' . $this->uri->segment(3) . '/' . $this->uri->segment(4)) ?>" class="btn btn-primary" target="_BLANK">Cetak</a>
			<a href="<?= base_url('admin/excel_umum/' . $this->uri->segment(3) . '/' . $this->uri->segment(4)) ?>" class="btn btn-success">Export Excel</a>
		</div>
	</div>
	<!-- Footer -->
